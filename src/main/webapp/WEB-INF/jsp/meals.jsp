...
<%--                            <label for="startDate"><spring:message code="meal.endDate"/></label>--%>
<%--                            <input class="form-control" name="startDate" id="startDate" autocomplete="off">--%>
<%--                        </div>--%>
<%--                        <div class="col-2">--%>
<%--                            <label for="endDate"><spring:message code="meal.endTime"/></label>--%>
...
<%--                <button class="btn btn-danger" &lt;%&ndash;onclick="clearFilter()"&ndash;%&gt;>--%>
<%--                    <span class="fa fa-remove"></span>--%>
<%--                    <spring:message code="common.cancel"/>--%>
<%--                </button>--%>
<%--                <button class="btn btn-primary" &lt;%&ndash;onclick="updateFilteredTable()"&ndash;%&gt;>--%>
...
<%--        </div>--%>
        ...
        <div id="filter">
            ...
            <button type="bu" class="btn btn-primary" onclick="filter_params()">
                <span class="fa fa-filter"></span>
                <spring:message code="meal.filter"/>
            </button>
        </div>
                ...
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="description" name="description"
                               placeholder="<spring:message code="meal.description"/>" size="40" required>
                    </div>
